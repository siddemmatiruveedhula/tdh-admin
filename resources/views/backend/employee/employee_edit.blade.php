                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" class="row g-3" action="{{ route('employee.update') }}" id="contactForm"
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-group">
                                        <input name="name" id="name" value="{{ old('name', $employee->name) }}"
                                ...
                                <!-- end row -->
                                <div class="col-4">
                                    <label for="example-text-input" class="form-label">User Name<span
                                            class="text-danger">*</span> </label>
                                    <div class="form-group">
                                        <input type="text" name="username" id="username" class="form-control"
                                            placeholder="Name" value="{{ old('username', $user->username) }}">
                                ...
                                <div class="col-4">
                                    <label for="example-text-input" class="form-label">Personal Email</label>
                                    <div class="form-group">
                                        <input name="email" id="email" value="{{ old('email', $employee->email) }}"
                                ...
                                <div class="col-4">
                                    <label for="example-text-input" class="form-label">Personal Phone</label>
                                    <div class="form-group ">
                                ...
                                <!-- end row -->
                                <div class="col-4">
                                    <label for="example-text-input" class="form-label">Organization Phone <span
                                            class="text-danger">*</span></label>
                                    <div class="form-group ">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-group">
                                        <input name="employee_code" id="employee_code"
                                ...
                                <!-- end row -->
                                <div class="col-4">
                                    <label for="example-text-input" class="form-label">Role <span
                                            class="text-danger">*</span> </label>
                                    <div class="form-group">
                                ...
                                <div class="col-4">
                                    <label for="example-text-input" class="form-label">POC - 1</label>
                                    <div class="form-group">
                                        <select name="poc_1" id="poc_1" class="form-select select2">
                                            <option value="">--Select POC --</option>
                                            @foreach ($employee_pocs as $employee_poc)
                                                <option value="{{ $employee_poc->id }}"
                                                    {{ old('poc_1', $employee->poc_1) == $employee_poc->id ? 'selected' : '' }}>
                                                    {{ $employee_poc->name }}( {{ $employee_poc->role->name ?? '' }} )
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-4">
                                    <label for="example-text-input" class="form-label">POC - 2</label>
                                    <div class="form-group">
                                        <select name="poc_2" id="poc_2" class="form-select select2">
                                            <option value="">--Select POC --</option>
                                            @foreach ($employee_pocs as $employee_poc)
                                                <option value="{{ $employee_poc->id }}"
                                                    {{ old('poc_2', $employee->poc_2) == $employee_poc->id ? 'selected' : '' }}>
                                                    {{ $employee_poc->name }}
                                                    ({{ $employee_poc->role->name ?? '' }})
                                                </option>
                                                {{-- $bew->category?$item->category->name:'-' --}}
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-group">
                                        <select name="department_id" id="department_id" class="form-select select2"
                                            aria-label="Select Department" onchange="getDivisions()">
                                            <option value="" disabled selected>--Select Department--</option>
                                            @foreach ($departments as $department)
                                                <option value="{{ $department->id }}"
                                                    {{ old('department_id', $employee->division->department_id ?? '') == $department->id ? 'selected' : '' }}>
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-group ">
                                        <input name="daily_allowance" class="form-control" type="text"
                                            placeholder="Daily Allowance" id="daily_allowance"
                                            value="{{ old('daily_allowance', $employee->daily_allowance) }}">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-group">
                                        <select name="status" class="form-select" aria-label="Select status">
                                            <option {{ old('status', $employee->status) == 1 ? 'selected' : '' }}
                                                value="1">Active
                                            </option>
                                            <option {{ old('status', $employee->status) == 0 ? 'selected' : '' }}
                                                value="0">Inactive
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-group ">
                                        <input name="working_location" id="working_location" class="form-control"
                                            ...
                                            value="{{ old('working_location', $employee->working_location) }}">
                                ...
                                <div class="col-4">
                                    <label for="example-text-input" class="form-label">New Image
                                    </label>
                                    <div class="form-group">
                                ...
                                <div class="col-4">
                                    <label for="example-text-input" class="form-label">Existing Image </label>
                                    <div class="form-group">
                                        <img id="showImage" class="rounded avatar-lg"
                                            src="{{ asset('upload/employees/' . $employee->image) }}"
                                            alt="Card image cap">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="text-center">
                                    <input type="submit" id="employee_submit"
                                        class="btn btn-info waves-effect waves-light" value="Update employee">
                                </div>
        ...
        $(document).ready(function() {
            $("#contactForm").submit(function(e) {
                ...
                if (emp_name_has_error) {
                    ...
                    division_id.focus();
                    return false;
                } else if (daily_allowance_has_error) {
                    daily_allowance.focus();
                    return false;
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if ($.isEmptyObject(data.error)) {
                                ...
                                toastr.success(data.message, 'Employee Updated successfully!');
                            } else {
