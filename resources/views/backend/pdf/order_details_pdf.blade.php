    ...
    <div class="row">
        <div class="col-12">
            <div class="order-title">
                <h4 class="float-end font-size-16"><strong>Order No # {{ $payment['order']['order_no'] }}</strong></h4>
                <h3>
...
<div class="table-responsive">
   ...
   $order_details = App\Models\OrderDetail::where('order_id',$payment->order_id)->get();     
        @endphp
...
@php
$payment_details = App\Models\PaymentDetail::where('order_id',$payment->order_id)->get();
