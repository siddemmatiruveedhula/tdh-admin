...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-center"><strong>Organization Name </strong></td>
...
$selling_total = App\Models\OrderDetail::where('category_id',$item->category_id)->where('product_id',$item->id)->where('status','1')->sum('selling_qty');
@endphp
