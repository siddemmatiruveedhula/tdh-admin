 ...
 <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Daily Store Report</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li>
                                            <li class="breadcrumb-item active">Daily Store Report</li>
                                        </ol>
                                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="order-title">
                ...
                <h3>
                    <img src="{{ asset('backend/assets/images/logo-sm.png') }}" alt="logo" height="24"/> Tenali  Doule Horse
                </h3>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col-6 mt-4">
                    <address>
                        <strong>Tenali  Doule Horse:</strong><br>
                        Autonagar, Tenali<br>
                        support@tenalidoublehorse.com
                    </address>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div>
                <div class="p-2">
                    <h3 class="font-size-16"><strong>Daily Store Report 
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-center"><strong>Store No </strong></td>
      ...
      @php
        ...
        @endforeach
            ...
            <tr>
                ...
                <td class="no-line text-end"><h4 class="m-0">Rs.{{ $total_sum}}</h4></td> --}}
            </tr>
                            </tbody>
                        </table>
                    </div>
