                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Update Organization </h4><br><br>
                            ...
                            <form method="post" class="row g-3" action="{{ route('supplier.update') }}" id="myForm">
                                @csrf
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <input name="mobile_no" value="{{ old('mobile_no',$supplier->mobile_no) }}" class="form-control"
                                            type="text">
                                    </div>
                                </div>
                                <!-- end row -->
