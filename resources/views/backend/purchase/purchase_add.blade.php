    ...
    <div class="container-fluid">
         ...
         <div class="row">
            <div class="col-12">
                ...
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('purchase.all') }}">Store</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Add Store </h4><br><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4  mb-3">
                                <div class="md-3">
                                    <label for="example-text-input" class="form-label">Store No</label>
                            ...
                            <div class="col-md-4  mb-3">
                                <div class="md-3">
                                    <label for="example-text-input" class="form-label">Organization Name </label>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('purchase.store') }}">
                            ...
                            <table class="table-sm table-bordered" width="100%" style="border-color: #ddd;">
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="4"></td>
                                        <td>
                                            <input type="hidden" name="estimated_amount" value="0" id="estimated_amount"
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-info" id="storeButton"> Add Store</button>
...
<script id="document-template" type="text/x-handlebars-template">
    ...
    <td>
     ...
     <td>
        ...
        <input type="hidden" class="form-control unit_price text-right" name="unit_price[]" value="1"> 
        <input type="hidden" class="form-control buying_price text-right" name="buying_price[]" value="1"> 
    </td>
        ...
        $(document).on("click",".addeventmore", function(){
            ...
            if(date == ''){
                ...
                return false;
                  ...
                  if(purchase_no == ''){
                $.notify("Store No is Required" ,  {globalPosition: 'top right', className:'error' });
                return false;
                 }
