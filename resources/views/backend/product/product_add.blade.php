                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" class="row g-3" action="{{ route('product.store') }}" id="myForm">
                                @csrf
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <input name="max_price" id="max_price" class="form-control"
                                            placeholder="Max Price (MRP) " type="text">
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <label for="total_weight_in_qtl" class="form-label">Total Weight (in QTL)<span
                                            class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <input name="total_weight_in_qtl" id="total_weight_in_qtl" class="form-control"
                                            placeholder="Total Weight (in QTL)" type="number" min="0"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <input name="hsn_no" class="form-control" placeholder="HSN CODE"
                                            type="text">
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <select name="is_cess" id="is_cess" class="form-select"
                                            ...
                                            <option {{ old('is_cess') == 'Yes' ? 'selected' : '' }} value="Yes">Yes
                                            </option>
                                            <option {{ old('is_cess') == 'No' ? 'selected' : '' }} value="No">No
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <input name="units_per_case" placeholder="Units Per Case" class="form-control"
                                            type="text">
                                    </div>
                                </div>
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <select name="is_promo_sku" id="is_promo_sku" class="form-select">
                                            <option {{ old('is_promo_sku') == 'Yes' ? 'selected' : '' }} value="Yes">
                                                Yes
                                            </option>
                                            <option {{ old('is_promo_sku') == 'No' ? 'selected' : '' }} value="No">No
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <label for="product_description" class="form-label">Product
                                        Description</label>
                                    <div class="form-group">
                                        <textarea name="product_description" placeholder="Please Enter Product Description..." id="product_description"
                                            class="form-control">{{ old('product_description') }}</textarea>
                                    </div>
                                </div>
