        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('customer-category-type.all') }}">Customer Category
                                    Type</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Add Customer Category Type </h4><br><br>



                            <form method="post" action="{{ route('customer-category-type.store') }}" id="myForm">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Customer Category Type
                                ...
                                <input type="submit" id="submit_button" class="btn btn-info waves-effect waves-light"
                                    value="Add Customer Category">
                            </form>
        ...
        $(document).ready(function() {
            ...
            $('#myForm').validate({
                ...
                submitHandler: function(form) {
                    $.ajax({
                        url: "{{ route('customer-category-type.store') }}",
                        type: "POST",
                        data: $(form).serialize(),
                        beforeSend: function() {
                        ...
                        success: function(data) {
                            ...
                            if ($.isEmptyObject(data.error)) {
                                ...
                                toastr.success(data.message, 'Inserted successfully!');
                            } else {
