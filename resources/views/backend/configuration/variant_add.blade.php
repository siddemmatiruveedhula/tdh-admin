                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Add Variant </h4><br><br>
                            ...
                            <form method="post" class="row g-3" action="{{ route('variant.store') }}" id="myForm">
                                @csrf
                                ...
                                <div class="text-left">
                                    <input type="submit" class="btn btn-info waves-effect waves-light" value="Add Variant">
                                </div>
