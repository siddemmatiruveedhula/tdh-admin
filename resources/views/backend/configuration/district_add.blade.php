                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Add District</h4><br><br>
                            @if (count($errors) > 0)
                            ...
                            @endif
                            <form method="post" class="row g-3" action="{{ route('district.store') }}" id="myForm">
                                @csrf
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-group">
                                        <input name="name" value="{{ old('name') }}" placeholder="District Name" class="form-control"
                                            type="text">
                                    </div>
                                </div>
                                <div class="col-4">
    ...
    <script>
        $(document).ready(function() {
            ...
            jQuery(document).ready(function($) {
                if (jQuery("#state-dropdown").data('oldid') != '' && typeof(jQuery(
                        "#state-dropdown").data('oldid')) != "undefined") {
                    jQuery("#country-dropdown").change();
                }
            });
            /*------------------------------------------
            --------------------------------------------
            ...
            $('#country-dropdown').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (jQuery("#state-dropdown").data('oldid') != '' && typeof(jQuery(
                                "#state-dropdown").data('oldid')) != "undefined") {
                            jQuery('#state-dropdown').val(jQuery("#state-dropdown")
                                .data('oldid')); //select the old doctor id here
                        }
