                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Edit State</h4><br><br>
                            @if (count($errors) > 0)
                            ...
                            @endif
                            <form method="post" class="row g-3" action="{{ route('state.update') }}" id="myForm">
                                @csrf
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-group">
                                        <input name="name" value="{{ old('name', $state->name) }}" class="form-control"
