                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Add Storage Type </h4><br><br>
                            ...
                            <form method="post" action="{{ route('storage-type.store') }}" id="myForm">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="name" class="form-control" type="text" value="{{ old('name') }}" placeholder="Storage Type">
                                    </div>
                                </div>
                                <!-- end row -->


                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Add Storage Type">
                            </form>
