                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Update Vehicle Type </h4><br><br>
                            ...
                            <form method="post" class="row g-3" action="{{ route('vehicle.update') }}" id="myForm">
                                @csrf
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <input name="name" value="{{ old('name', $vehicleType->name) }}" class="form-control"
                                            type="text">
                                        @if ($errors->has('name'))
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <select name="status" class="form-select" aria-label="Select status">
                                            <option {{ old('status', $vehicleType->status) == 1 ? 'selected' : '' }}
                                                value="1">Active
                                            </option>
                                            <option {{ old('status', $vehicleType->status) == 0 ? 'selected' : '' }}
                                                value="0">Inactive
                                            </option>
                                        </select>
                                    </div>
