  ...
  <a href="{{ route('credit.customer') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fa fa-list"> Back </i></a> <br>  <br>
    ...
    <div class="row">
        <div class="col-12">
            <div>
                <div class="p-2">
     <h3 class="font-size-16"><strong>Customer Order ( Order No: #{{ $payment['order']['order_no'] }} ) </strong></h3>
                </div>
                <div class="">
<div class="table-responsive">
   ...
   <form method="post" action="{{ route('customer.update.order',$payment->order_id)}}">
          @csrf     
...
$order_details = App\Models\OrderDetail::where('order_id',$payment->order_id)->get();
        ...
        <input type="text" name="paid_amount" class="form-control paid_amount" placeholder="Enter Paid Amount" style="display:none;">
            ...
            <div class="form-group col-md-3">
                ...
                <button type="submit" class="btn btn-info">Order Update</button>
            </div>
