...
@section('admin')
 ...
 <div class="page-content">
    ...
    <tr>
        ...
        <td>
   <a href="{{ route('customer.edit.order',$item->order_id) }}" class="btn btn-info sm" title="Edit Data">  <i class="fas fa-edit"></i> </a>

     <a href="{{ route('customer.order.details.pdf',$item->order_id) }}" target="_blank" class="btn btn-info sm" title="Customer Order Details">  <i class="fa fa-eye" aria-hidden="true"></i> </a>
